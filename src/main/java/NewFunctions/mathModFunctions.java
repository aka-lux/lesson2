...
public class mathModFunctions {
    /**
     * Главный метод, можно использовать для запуска собственных методов
     * @param args - принимает такие аргументы
     * @throws IOException - может выбросить такое исключение
     */
...
//        task411();
    ...
    /**
     * Задание 4.1 Напишите метод, который принимает с клавиатуры целое положительное двузначное число
    ...
    /**
     * Задание 4.2 Напишите метод, который принимает с клавиатуры целое положительное трехзначное число
     * и выводит на экран его цифры, разделенные  знаком «пробел».
     */
    ...
    /**
     * Задание 4.3  Напишите метод, который принимает с клавиатуры целое положительное двузначное число
    ...
    /**
     *Задание 4.4 Напишите метод, который принимает с клавиатуры целое положительное трехзначное число
     * и выводит на экран его цифры, разделенные знаком «пробел», но в обратном порядке. То есть для числа 415 будет
    ...
    /**
     * Задание 4.5 Напишите метод, который принимает с клавиатуры целое положительное двузначное число
     * и выводит его на экран в «полном виде»: например, для числа 34 это будет выглядеть как 30+4.
     */
    ...
    /**
     * Задание 4.6 Напишите метод, который принимает с клавиатуры целое положительное трехзначное число
    ...
    /**
     * Задание 4.7 Напишите метод, который принимает с клавиатуры целое положительное двузначное число.
    ...
    /**
     * Задание 4.11 Назовем «длиной двузначного числа» разницу между числом десятков(первая цифра)
     * и числом единиц (вторая цифра). Напишите метод, который принимает с клавиатуры двузначное число и
    ...
    /**
     * Задание 4.12 Назовем «длиной трехзначного числа» разницу между его первой (число сотен)
     * и последней (число единиц) цифрами, умноженную на его среднюю (число десятков) цифру.
     * Напишите метод, который принимает с клавиатуры целое положительное трехзначное число,
     * вычисляет его «длину» и выводит результат на экран.
     */
    public static void task412(){
        //TODO: доделать
    }

    /**
     * Пример про типы данных
     */
